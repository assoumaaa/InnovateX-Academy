...
export const Definition = () => {
    ...
    return (
        <div className="def-wrapper designThinking">
            <h1>What is <u>Design Thinking?</u></h1>
            <span><h1>Definition: </h1>Design thinking is a human-centered approach to problem-solving and innovation that can be applied to a wide range of challenges, from product design to organizational strategy to social issues.By participating in a 14-week program that teaches design thinking and the necessary steps you will transform your concept into a business strategy.</span>
