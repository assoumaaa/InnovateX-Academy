...
export const StartingEmpathyMap = ({ SetEmpathyMapTask, SetStartingEmpathyMap }) => {
    return (
        <div className="startingEmpathyMap">
            ...
            <button onClick={() => { SetEmpathyMapTask(true); SetStartingEmpathyMap(false); }}>Let's Start!</button>
        </div>
    )
}
