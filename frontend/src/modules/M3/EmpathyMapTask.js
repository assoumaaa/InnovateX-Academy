...
export const EmpathyMapTask = () => {
    return (
        <div className="empathyMapTask">
            ...
            <textarea />
            <hr />
            <h1>2.What we want them to do?</h1>
            <ul>
            ...
            <h2>We can consider this part as answers to the question "What is their problem?", "What are they looking to solve", " What are they looking to do differently that they currently having problems or issues with?"</h2>
            <textarea />
            <hr />
            ...
            <h2>In this part we focus in the environment, so we answer question like "What environment are they in when they are experiencing the problem that we are trying to solve?", "What surrounds them?", "Who’s around them?", "What is life like for them in this environment ?"</h2>
            <textarea />
        </div>
    )
}